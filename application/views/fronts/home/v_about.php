        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="overlay_bg about_video_img mb-4 mb-lg-0">
                    ...
                    <a link="false"  class="video_popup video_play"><img class="bounce_img" src="<?php echo base_url()?>assets/images/play-icon.png" alt="play-icon" allow="autoplay"></a>
                </div>
            </div>
...
<!-- href="https://youtube.com/watch?v=<?php echo $identitas->youtube_video?>" -->
