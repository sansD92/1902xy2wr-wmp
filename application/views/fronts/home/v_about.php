        ...
        <div class="row align-items-center">
            <div class="col-md-6" data-animation="fadeInLeft" data-animation-delay="0.2s">
                <div class="overlay_bg about_video_img mb-4 mb-lg-0">
                    ...
                    <a href="https://www.youtube.com/watch?v=8OS5G6BloiA" class="video_popup video_play"><img class="bounce_img" src="<?php echo base_url()?>assets/images/play-icon.png" alt="play-icon"></a>
                </div>
            </div>
