        ...
        <div class="row align-items-center">
            <div class="col-md-6" data-animation="fadeInLeft" data-animation-delay="0.2s">
                <div class="overlay_bg about_video_img mb-4 mb-lg-0">
                    ...
                    <a link="true" href="https://youtube.com/watch?v=jPSzKyY5NnY" class="video_popup video_play"><img class="bounce_img" src="<?php echo base_url()?>assets/images/play-icon.png" alt="play-icon" allow="autoplay"></a>
                </div>
            </div>
