                        ...
                        <div class="team_img">
                            ...
                            <ul class="list_none social_icons border_social">
                               <li>
                                    <h6 style="color: #fff"></h6></li>
                                    <!-- <a href="#" class="btn btn-outline-white">Lebih Detail</a> -->
                                    <button type="button" class="btn btn-outline-white" data-toggle="modal" data-target="#modal-2">Lebih Detail</button>
                            </ul>
                        </div>
                        <div class="team_title">
                        ...
                        <div class="team_img">
                            ...
                            <ul class="list_none social_icons border_social">
                               <li>
                                    <h6 style="color: #fff"></h6></li>
                                    <!-- <a href="#" class="btn btn-outline-white">Lebih Detail</a> -->
                                    <button type="button" class="btn btn-outline-white" data-toggle="modal" data-target="#modal-3">Lebih Detail</button>
                            </ul>
                        </div>
                        <div class="team_title">
