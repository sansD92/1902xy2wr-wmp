	...
	<div class="container-fluid">
    	<div class="row">
        	<div class="col-md-12 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
            	<ul class="list_none carousel_slide4 owl-carousel owl-theme image_gallery gallery_hover_style3" data-loop="true" data-margin="30" data-dots="false" data-autoplay="true" data-center="true">
                    <li>
                    ...
                    <li>
                      <div class="blog_post blog_style1">
                            ...
                            <div class="blog_content bg-white">
                            	<div class="blog_text">
                                    <h6 class="blog_title"><a href="#">Why are tickets to fly to Lagos expensive1</a></h6>
                                    <ul class="list_none blog_meta">
                                        <li><a href="#"><i class="ion-calendar"></i> April 14, 2018</a></li>
                                        <li><a href="#"><i class="ion-chatboxes"></i> 2 Comment</a></li>
                                	</ul>
...
<section>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <ul class="portfolio_container loadmore gutter_small work_col4 portfolio_gallery portfolio_style1" data-item="4" data-item-show="4">
