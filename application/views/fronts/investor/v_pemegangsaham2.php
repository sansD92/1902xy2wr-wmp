        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="page-title">
                    <h1>Struktur Pemegang Saham</h1>
                </div>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="#">Beranda</a></li>
                    <li class="breadcrumb-item"><a>Investor</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Struktur Pemegang Saham</li>
                  </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-12 col-sm-12 mb-12 mb-lg-0 ">
                ...
                <div>
                    <img style="width: 100%;height: auto"src="<?php echo base_url()?>assets/frontend/maknawmp.png" alt="filosofi"/>
                </div>
            </div>
