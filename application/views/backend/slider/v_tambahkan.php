      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="card card-primary">
            ...
            echo form_open_multipart('aspanel/slider_tambahkan',$attributes); ?>
              <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label>Judul</label>
                        <input type="text" class="form-control" name="slider_judul" placeholder="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
              ...
              <div class="card-footer">
                ...
                <a class="btn btn-outline-info" title="Batal" href="<?php echo base_url()?>aspanel/slider"><i class="fab fa-creative-commons-sa"></i> Batal</a>
